...
void selectionSort(int *array, int size)
{
    ...
    for (int startIndex = 0; startIndex < size; ++startIndex)
    {
        ...
        for (int currentIndex = startIndex + 1; currentIndex < size; ++currentIndex)
        {
            ...
            if (currentIndex < bestIndex) // COMPARISON DONE HERE
...
int main()
{
    ...
    // calling a function using a function pointer via implicit dereference
     (*fcnPtr3)(2,5.0); // call function goo(2,5.0) through fcnPtr3 implicit dereference
    ...
    selectionSort(array,9); // [2.1] sort array in descending order
    printArray(array, 9);
 
    // TEMP - COMPLETE FUNCTION CALL AND UNCOMMENT LINE BELOW
    selectionSort(array,9); // [2.2] sort array in ascending order
    printArray(array, 9);
...
/* virtual function1() -> calls Base::function2() */
/* virtual function2() -> calls Base::function2() */
/**************************************************/

/******* D2 Class Virtual Function Table **********/
/* virtual function1() -> calls Base::function1() and Base::function3() */
/* virtual function2() -> calls Base::function1() and Base::function3() */
/* virtual function3() -> calls Base::function1() and Base::function3() */
/**************************************************/

/******* D3 Class Virtual Function Table **********/
/* virtual function1() -> calls Base::function2() */
/* virtual function2() -> calls Base::function2() */
/* virtual function3() -> calls Base::function2() */
/**************************************************/
...
// dptr, which is a reference to d2, is a function pointer to function1().
